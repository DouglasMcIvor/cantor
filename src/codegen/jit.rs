    ...
    pub fn into_jit_engine(self) -> Result<ExecutionEngine<'ctx>, String> {
        ...
        let mappings: Vec<(FunctionValue<'ctx>, usize)> = {
            let rt: &[(&str, usize)] = &[
                ...
                // Nested vectors (X**) — CantorListVec unified type
                ...
                ("cantor_list_vec_builder_new_list_i64",  runtime::cantor_list_vec_builder_new_list_i64  as *const () as usize),
                ("cantor_list_vec_builder_push_list_i64", runtime::cantor_list_vec_builder_push_list_i64 as *const () as usize),
                ("cantor_list_vec_builder_finish_list_i64", runtime::cantor_list_vec_builder_finish_list_i64 as *const () as usize),
                ("cantor_list_vec_get_list_i64",          runtime::cantor_list_vec_get_list_i64          as *const () as usize),
                ("cantor_list_vec_concat_list_i64",       runtime::cantor_list_vec_concat_list_i64       as *const () as usize),
