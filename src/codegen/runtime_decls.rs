...
impl<'ctx> Compiler<'ctx> {
    ...
    pub fn declare_runtime_functions(&mut self) {
        ...
        // Set(Int) ABI
        self.module
            .add_function("cantor_set_new_i64", i64t.fn_type(&[], false), None);
        self.module
            .add_function("cantor_set_insert_i64", void.fn_type(ii, false), None);
        self.module
            .add_function("cantor_set_contains_i64", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_set_size_i64", i64t.fn_type(i, false), None);
        self.module
        ...
        self.module
            .add_function("cantor_set_insert_bool", void.fn_type(ii, false), None);
        self.module
            .add_function("cantor_set_contains_bool", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_set_size_bool", i64t.fn_type(i, false), None);
        self.module
            .add_function("cantor_set_get_bool", i64t.fn_type(ii, false), None);

        // Vector(Int) ABI — Apache Arrow Int64Array, pointer-as-i64.
        self.module
            .add_function("cantor_vec_builder_new_i64", i64t.fn_type(&[], false), None);
        self.module
            .add_function("cantor_vec_builder_push_i64", void.fn_type(ii, false), None);
        self.module.add_function(
        ...
        self.module
            .add_function("cantor_vec_get_i64", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_vec_push_i64", i64t.fn_type(ii, false), None);
        ...
        self.module
            .add_function("cantor_vec_len_bool", i64t.fn_type(i, false), None);
        self.module
            .add_function("cantor_vec_get_bool", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_vec_push_bool", i64t.fn_type(ii, false), None);

        // Concatenation — both take two i64 pointers and return a new i64 pointer.
        self.module
            .add_function("cantor_vec_concat_i64", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_vec_concat_bool", i64t.fn_type(ii, false), None);
        ...
        self.module
            .add_function("cantor_list_vec_len", i64t.fn_type(i, false), None);
        self.module
            .add_function("cantor_list_vec_get", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_list_vec_concat", i64t.fn_type(ii, false), None);
        ...
        self.module
            .add_function("cantor_struct_vec_len", i64t.fn_type(i, false), None);
        self.module.add_function(
            "cantor_struct_vec_get_field",
            i64t.fn_type(iii, false),
            None,
        );
        self.module
            .add_function("cantor_struct_vec_concat", i64t.fn_type(ii, false), None);
        ...
        self.module
            .add_function("cantor_union_vec_builder_new", i64t.fn_type(i, false), None);
        self.module.add_function(
        ...
        self.module
            .add_function("cantor_union_vec_len", i64t.fn_type(i, false), None);
        self.module
            .add_function("cantor_union_vec_get_tag", i64t.fn_type(ii, false), None);
        self.module
            .add_function("cantor_union_vec_get_leaf", i64t.fn_type(iii, false), None);
        self.module
            .add_function("cantor_union_vec_concat", i64t.fn_type(ii, false), None);
